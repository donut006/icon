...
//设计原则，以黑名单为基础，但是当临时将漏网之鱼切换为代理的时候，也应该支持国内的网络进行直连
...
const ruleOptionsEnable = {
  ...
  油管视频: true, // YouTube视频平台
  电报消息: true, // Telegram通讯软件
  X: true, // Twitter社交平台
  Instagram: true, // Instagram社交平台
  TikTok: true, // TikTok视频平台
  Netflix: false, // Netflix视频平台
  Emby: false, // Emby媒体服务
...
const prefixRules = [
  // 私有网络直连
  'RULE-SET,site-private,直连',

  // 国内直连
  'RULE-SET,site-geolocation-cn,直连',
  'RULE-SET,site-category-games@cn,直连', // 已包含 steam 下载域名
  'RULE-SET,site-epicgames,直连',
  'RULE-SET,site-nvidia@cn,直连',
  'RULE-SET,site-apple@cn,直连',
  'RULE-SET,site-microsoft@cn,直连',
  'DOMAIN,fsend.cn,直连',
...
const blockForeignQuic = [
  'AND,((NETWORK,UDP),(DST-PORT,443),(OR,((RULE-SET,site-geolocation-!cn),(NOT,((RULE-SET,ip-cn,no-resolve)))))),REJECT',
];

// 定义后置规则
const suffixRules = [
  'RULE-SET,site-geolocation-!cn,默认代理',
  'RULE-SET,ip-cn,直连,no-resolve',
  'RULE-SET,ip-private,直连',
];
...
const baseRuleProviders = {
  ...
  'site-private': {
    ...
    path: './ruleset/MetaCubeX/geo/geosite/private.mrs',
  ...
  'site-epicgames': {
    ...
    path: './ruleset/MetaCubeX/geo/geosite/epicgames.mrs',
  ...
  'site-nvidia@cn': {
    ...
    path: './ruleset/MetaCubeX/geo/geosite/nvidia@cn.mrs',
  ...
  'site-apple@cn': {
    ...
    path: './ruleset/MetaCubeX/geo/geosite/apple@cn.mrs',
  ...
  'ip-cn': {
    ...
    path: './ruleset/MetaCubeX/geo/geoip/cn.mrs',
  ...
  'site-fakeip-filter': {
    ...
    path: './ruleset/appshubcc/geo/geosite/fakeip-filter.mrs',
...
const serviceConfigs = [
  {
    ...
    providers: {
      'site-category-ai-!cn': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/category-ai-!cn.mrs',
        'path-in-bundle': 'geo/geosite/category-ai-!cn.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/chatgpt.svg',
  ...
  },
  {
    ...
    providers: {
      'site-google': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/google.mrs',
        'path-in-bundle': 'geo/geosite/google.mrs',
      },
      'ip-google': {
        ...ruleProviderCommonIpcidr,
        url: 'https://cdn.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@meta/geo/geoip/google.mrs',
        path: './ruleset/MetaCubeX/geo/geoip/google.mrs',
        'path-in-bundle': 'geo/geoip/google.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/google.svg',
    rules: ['RULE-SET,site-google,谷歌服务', 'RULE-SET,ip-google,谷歌服务,no-resolve'],
  },
  {
    name: 'GitHub',
    baseOption: selectBaseOption,
    providers: {
      'site-github': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/github.mrs',
        'path-in-bundle': 'geo/geosite/github.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/github.svg',
    rules: ['RULE-SET,site-github,GitHub'],
  },
  {
    name: '油管视频',
    baseOption: selectBaseOption,
    providers: {
      'site-youtube': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/youtube.mrs',
        'path-in-bundle': 'geo/geosite/youtube.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/youtube.svg',
    rules: ['RULE-SET,site-youtube,油管视频'],
  },
  {
    name: '电报消息',
    baseOption: selectBaseOption,
    providers: {
      'site-telegram': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/telegram.mrs',
      ...
      'ip-telegram': {
        ...
        path: './ruleset/MetaCubeX/geo/geoip/telegram.mrs',
        'path-in-bundle': 'geo/geoip/telegram.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/telegram.svg',
    rules: ['RULE-SET,site-telegram,电报消息',
      'RULE-SET,ip-telegram,电报消息,no-resolve',
      'PROCESS-NAME,Telegram.exe,电报消息',             // Windows
      'PROCESS-NAME,org.telegram.messenger,电报消息',   // Android
      'PROCESS-NAME,Telegram,电报消息',                 // macOS
      'PROCESS-NAME,telegram-desktop,电报消息',         // Linux
    ],
  },
  {
    name: 'X',
    ...
    providers: {
      'site-x': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/x.mrs',
        'path-in-bundle': 'geo/geosite/x.mrs',
      },
      'site-twitter': {
        ...ruleProviderCommonDomain,
        url: 'https://cdn.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@meta/geo/geosite/twitter.mrs',
        path: './ruleset/MetaCubeX/geo/geosite/twitter.mrs',
        'path-in-bundle': 'geo/geosite/twitter.mrs',
      },
      'ip-twitter': {
        ...ruleProviderCommonIpcidr,
        url: 'https://cdn.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@meta/geo/geoip/twitter.mrs',
        path: './ruleset/MetaCubeX/geo/geoip/twitter.mrs',
        'path-in-bundle': 'geo/geoip/twitter.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/x.svg',
    rules: ['RULE-SET,site-x,X', 'RULE-SET,site-twitter,X', 'RULE-SET,ip-twitter,X,no-resolve'],
  },
  {
    name: 'Instagram',
    baseOption: selectBaseOption,
    providers: {
      'site-instagram': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/instagram.mrs',
        'path-in-bundle': 'geo/geosite/instagram.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/instagram.svg',
    rules: ['RULE-SET,site-instagram,Instagram'],
  },
  {
    name: 'TikTok',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-tiktok': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/tiktok.mrs',
        'path-in-bundle': 'geo/geosite/tiktok.mrs',
      },
      'ip-tiktok': {
        ...ruleProviderCommonIpcidr,
        url: 'https://fastly.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/tiktok.mrs',
        path: './ruleset/appshubcc/geo/geoip/tiktok.mrs',
        'path-in-bundle': 'geo/geoip/tiktok.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/tiktok.svg',
    rules: ['RULE-SET,site-tiktok,TikTok', 'RULE-SET,ip-tiktok,TikTok,no-resolve'],
  },
  {
    name: 'Netflix',
    baseOption: selectBaseOption,
  ...
  },
  {
    ...
    providers: {
      'emby': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/emby.mrs',
      ...
      'emos': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/emos.mrs',
        'path-in-bundle': 'geo/geosite/category-emby.mrs',
      },
    },
  ...
  },
  {
    ...
    providers: {
      'site-steam': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/steam.mrs',
        'path-in-bundle': 'geo/geosite/steam.mrs',
      },
      'ip-steam': {
        ...ruleProviderCommonIpcidr,
        url: 'https://fastly.jsdelivr.net/gh/appshubcc/bett-rules@meta/geo/geoip/steam.mrs',
        path: './ruleset/appshubcc/geo/geoip/steam.mrs',
        'path-in-bundle': 'geo/geoip/steam.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/steam.svg',
    rules: ['RULE-SET,site-steam,Steam', 'RULE-SET,ip-steam,Steam,no-resolve'],
  },
  {
    name: 'Microsoft',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-microsoft': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/microsoft.mrs',
        'path-in-bundle': 'geo/geosite/microsoft.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/microsoft.svg',
    rules: ['RULE-SET,site-microsoft,Microsoft'],
  },
  {
    name: 'Apple',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-apple': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/apple.mrs',
        'path-in-bundle': 'geo/geosite/apple.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/apple.svg',
    rules: ['RULE-SET,site-apple,Apple'],
  },
  {
    name: 'PikPak',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-pikpak': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/pikpak.mrs',
    ...
    rules: ['RULE-SET,site-pikpak,PikPak'],
  },
  {
    name: 'Spotify',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-spotify': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/spotify.mrs',
        'path-in-bundle': 'geo/geosite/spotify.mrs',
      },
      'ip-spotify': {
        ...ruleProviderCommonIpcidr,
        url: 'https://cdn.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@meta/geo/geoip/spotify.mrs',
        path: './ruleset/MetaCubeX/geo/geoip/spotify.mrs',
        'path-in-bundle': 'geo/geoip/spotify.mrs',
      },
    },
    icon: 'https://fastly.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Spotify.png',
    rules: ['RULE-SET,site-spotify,Spotify', 'RULE-SET,ip-spotify,Spotify,no-resolve'],
  },
  {
    name: 'Crypto',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-category-cryptocurrency': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/category-cryptocurrency.mrs',
    ...
    rules: ['RULE-SET,site-category-cryptocurrency,Crypto'],
  },
  {
    name: 'EHentai',
    baseOption: selectBaseOption,
    ...
    providers: {
      'site-ehentai': {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/ehentai.mrs',
    ...
    rules: ['RULE-SET,site-ehentai,EHentai'],
  },
  {
    name: 'FCM',
    baseOption: selectBaseOption,
  ...
  },
  {
    ...
    providers: {
      adblockmihomolite: {
        ...
        path: './ruleset/MetaCubeX/geo/geosite/adblockmihomolite.mrs',
        'path-in-bundle': 'geo/geosite/category-ads-all.mrs',
      },
    },
    icon: 'https://cdn.jsdelivr.net/gh/donut006/icon/icon2/adblock.svg',
    rules: ['RULE-SET,adblockmihomolite,广告拦截'],
  },
];
const serviceConfigs2 = [
  ...baseGroups,
]
...
function buildFunctionalGroups(filteredProxies, generatedRegionGroups, customizeInfo) {
  ...
  functionalGroups.push({
    ...selectBaseOption,
    name: '漏网之鱼',
    proxies: ['直连', '默认代理', ...groupNamesOfSelect],
  ...
  for (const svc of serviceConfigs2) {
    if (!ruleOptionsEnable[svc.name]) continue;
...
const chinaIPDohDNS = ['https://223.5.5.5/dns-query#DIRECT', 'https://1.12.12.12/dns-query#DIRECT'];
const chinaDohDNS = [
  'https://dns.alidns.com/dns-query#DIRECT', // 阿里DoH
  'https://doh.pub/dns-query#DIRECT', // 腾讯DoH
];
...
function buildDnsAndHostsConfig(config, filteredProxies) {
  ...
  const dns = {
    ...
    'fake-ip-filter': [
      'rule-set:site-private',
      'rule-set:site-fakeip-filter',
      ...(ruleOptionsEnable['FCM'] ? ['rule-set:site-googlefcm'] : []),
      ...proxyFakeIpFilter,
    ],
    ...
    'default-nameserver': chinaIPDohDNS,


    'nameserver-policy': {
      'rule-set:site-private': ['system'],
      // 先放 fakeIpFilter 条目
      ...proxyFakeIpFilter.reduce((acc, domain) => {
        acc[domain] = ['system'];
        return acc;
      }, {}),

      'rule-set:site-category-ai-!cn': foreignDNS,
      'rule-set:site-google': foreignDNS,
      'rule-set:site-github': foreignDNS,
      'rule-set:site-youtube': foreignDNS,
      'rule-set:site-telegram': foreignDNS,
      'rule-set:site-x': foreignDNS,
      'rule-set:site-twitter': foreignDNS,
      'rule-set:site-instagram': foreignDNS,
      'rule-set:site-tiktok': foreignDNS,
      // 'rule-set:site-netflix': foreignDNS,
      // 'rule-set:emby': foreignDNS,
      // 'rule-set:emos': foreignDNS,
      'rule-set:site-steam': foreignDNS,
      'rule-set:site-microsoft': [...chinaDNS, ...foreignDNS],
      'rule-set:site-apple': foreignDNS,
      // 'rule-set:site-pikpak': foreignDNS,
      // 'rule-set:site-spotify': foreignDNS,
      // 'rule-set:site-category-cryptocurrency': foreignDNS,
      // 'rule-set:site-ehentai': foreignDNS,

      'geosite:gfw': foreignDNS, // GFW 列表域名强制走国外 DNS
    },
    'direct-nameserver': ['system', ...chinaDNS],
    nameserver: chinaDohDNS,
  };
